        ...
        <div className="md:col-span-2 space-y-6 text-left">
          <GlassCard className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="space-y-2">
                <label className="text-xs font-bold text-slate-500 uppercase tracking-widest">How did you hear about us?</label>
                <input 
                  value={data.source}
            ...
            <div className="space-y-2 mb-8">
              ...
              <textarea 
                ...
                className="w-full bg-black/20 border border-white/10 rounded-xl p-4 text-white placeholder:text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/50 resize-none" 
              />
            </div>

            <div className="flex items-center justify-between pt-4 border-t border-white/5">
                <div className="text-slate-500 text-sm">
                    {success && <span className="text-green-400 flex items-center gap-1"><ShieldCheck className="w-4 h-4" /> Changes saved!</span>}
                </div>
                <button 
                  onClick={handleUpdate}
                  disabled={loading}
                  className="bg-blue-600 hover:bg-blue-500 text-white font-bold py-3 px-8 rounded-xl transition-all flex items-center gap-2 shadow-lg shadow-blue-600/20 active:scale-95 disabled:opacity-50"
                >
          ...
          <GlassCard className="p-8 border-red-500/20">
             ...
             <p className="text-slate-500 text-sm mb-4">Deleting your account will permanently remove all your blogs and visual assets.</p>
             <button className="bg-red-500/10 hover:bg-red-500/20 text-red-500 border border-red-500/30 px-6 py-2 rounded-xl font-semibold transition-colors">
                 Delete Account
             </button>
          </GlassCard>
        </div>
